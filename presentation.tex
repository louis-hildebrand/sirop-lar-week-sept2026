...
\begin{frame}[fragile]{Recap: Project Goal}
    \begin{center}
        Goal: write high-level energy reconstruction algorithms, compile to resource-efficient VHDL
...
% TODO: show diagram of dacore, or at least mention "dacore" somewhere
...
\begin{frame}{\emph{Previous} Results, \texttt{dacore} FIR Filter}
    ...
    \begin{center}
        ...
        \begin{tabular}{lrrlr}
            ...
            \midrule
            Handwritten VHDL        & \qty{880}{\mega\hertz}        & 123\footnotemark[1]   &           & 3 \\
...
% TODO: add another line showing before MR vs after MR
% TODO: conclude that Sirop helped find improvement
...
\begin{frame}{\emph{Updated} Results, \texttt{dacore} FIR Filter}
    ...
    \begin{center}
        ...
        \begin{tabular}{lrrlr}
            ...
            \textbf{Design}                             & $\textbf{f}_{\textbf{max}}$   & \textbf{ALMs} & \textbf{DSPs} \\
            \midrule
            Handwritten VHDL, before \dspmergerequest   & \qty{880}{\mega\hertz}        & 123           & 3 \\
            Generated w/ \ourlang                       & \qty{823}{\mega\hertz}        & 118           & 3 \\
            Handwritten VHDL, after \dspmergerequest    & \qty{823}{\mega\hertz}        & 117           & 3 \\
            \bottomrule
        \end{tabular}
    \end{center}
...
\begin{frame}{Conclusion}
    \begin{columns}
        \begin{column}{0.8\textwidth}
            \begin{itemize}
                % TODO: more forceful conclusion
                    %       * looking into differences led to tangible improvements in resource usage (MR2) and reliability (MR1)
                ...
                \item Even after merge requests, \ourlang just about matches handwritten FIR filter, with much more concise source code

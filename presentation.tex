...
\begin{frame}[fragile]{Recap: Project Goal}
    \begin{center}
        ...
        \begin{tikzpicture}[
            ...
            process/.style={flowchartnode, rectangle, fill=blue!10, minimum height=2em, minimum width=5.5em},
    ...
    \begin{columns}
        \begin{column}{0.75\textwidth}
            \begin{itemize}
                ...
                \begin{itemize}
                    \item Neural networks (with CPPM, Dresden)
                    \item Optimal filter with forward corrections
                \end{itemize}
                % TODO: longer-term next steps (future directions?)
                % Faster exploration of different NN architectures (e.g., representation of weights, hyper networks)
            \end{itemize}
        \end{column}
